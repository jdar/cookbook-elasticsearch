...
# === AWS
default.elasticsearch[:aws][:access_key]    = "YOUR_ACCESS_KEY"
default.elasticsearch[:aws][:secret_key]    = "YOUR_SECRET_KEY"
default.elasticsearch[:aws][:s3][:bucket]   = "YOUR_BUCKET_NAME"
